...
const navItems = [
    ...
    },
    {
        ...
        name: 'Đồ thất lạc',
        subItems: [
            { name: 'Danh sách đồ thất lạc', icon: makeIcon('•'), path: '/lost-items' },
            { name: 'Thêm đồ thất lạc', icon: makeIcon('•'), path: '/lost-items/add' },
            { name: 'Tìm kiếm nâng cao', icon: makeIcon('•'), path: '/lost-items/search' }
        ]
    },
    {
        icon: <FileSearch />,
        name: 'Đã tìm thấy',
        subItems: [
            { name: 'Danh sách đã trả', icon: makeIcon('•'), path: '/found-items' },
            { name: 'Thống kê', icon: makeIcon('•'), path: '/found-items/stats' }
        ]
    },
    {
        ...
        name: 'Báo cáo',
        subItems: [
            { name: 'Báo cáo tháng', icon: makeIcon('•'), path: '/reports' },
            { name: 'Thống kê tổng hợp', icon: makeIcon('•'), path: '/reports/summary' },
            { name: 'Xuất báo cáo', icon: makeIcon('•'), path: '/reports/export' }
        ]
    },
];
...
const othersItems = [
    {
        ...
        subItems: [
            { name: 'Phân quyền', icon: makeIcon('•'), path: '/roles' }
        ]
    },
    {
        icon: <Settings />,
        name: 'Cấu hình',
        subItems: [
            { name: 'Thông tin trường', icon: makeIcon('•'), path: '/settings/school' },
            { name: 'Danh mục', icon: makeIcon('•'), path: '/settings/categories' },
            { name: 'Vị trí', icon: makeIcon('•'), path: '/settings/locations' }
        ]
    },
    {
        icon: <CircleUser />,
        name: 'Tài khoản',
        subItems: [
            { name: 'Thông tin cá nhân', icon: makeIcon('•'), path: '/profile' },
            { name: 'Đổi mật khẩu', icon: makeIcon('•'), path: '/profile/password' },
